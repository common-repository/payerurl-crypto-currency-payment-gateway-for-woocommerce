...
if (!class_exists("WC_Payerurl")) {
    ...
    final class WC_Payerurl extends WC_Payment_Gateway
    {
        ...
        public function testApiCreds()
        {
            ...
            if (!empty($this->enable_log)) self::log($this->apiVerifyURL);
            if (!empty($this->enable_log)) self::log($this->payerurl_public_key);
            if (!empty($this->enable_log)) self::log($this->payerurl_secret_key);
            if (!empty($this->enable_log)) self::log(json_encode($args));
